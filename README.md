This package is a modified version of cordova-plugin-code-push@2.0.0 that works with code-push@2.0.7 and cordova-lib@12.0.1
There were changes made in src/android/build-extras.gradle, bin/www/localPackage.js and bin/www/remotePackage.js
...
- Android ([cordova-android](https://github.com/apache/cordova-android) 4.0.0+) - _Including CrossWalk!_ _Note: Only on TLS 1.2 compatible devices_
...
_NOTE: for **Ionic** apps you need to run `ionic build` before running `cordova-release` or `release` command in order to build web assets._
...
_Note: If you've developed a Cordova app using CodePush, that is also open-source, please let us know. We would love to add it to this list!_
